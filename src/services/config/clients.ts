...
const fortniteAndroidGameClient = clientCredentialSchema.parse({
...
const fortnitePCGameClient = clientCredentialSchema.parse({
...
const launcherAppClient2 = clientCredentialSchema.parse({
